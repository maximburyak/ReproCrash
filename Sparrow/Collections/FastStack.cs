...
namespace Sparrow.Collections
{
    ...
    public class FastStack<T> : IEnumerable<T>       
    {
        ...
        public List<(string, T)> History = new List<(string, T)>();
